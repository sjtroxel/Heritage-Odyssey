...
- [ ] Vite dev proxy successfully routes `/api` calls to the local backend.
- [ ] All boilerplate Vite/CSS conflicts are removed; UI is 100% Tailwind-controlled.
- [ ] Authentication flow exists and allows users to access voice/narrative routes.
- [ ] The "Victorian Record Office" UI is fully implemented and responsive (375px to Desktop).
- [ ] API calls use the `VITE_API_URL` environment variable logic.
