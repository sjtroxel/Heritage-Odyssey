    ...
    <AnimatePresence mode="wait">
      {!isAuthenticated ? (
        ...
        <motion.div
          ...
          className="min-h-screen bg-paper text-ink selection:bg-brass/20"
        >
          {/* Header */}
                ...
                >
                  <div className="bg-[#fdfaf6]/80 backdrop-blur-sm p-8 border-l-4 border-brass shadow-lg">
                    <p className="text-lg md:text-xl text-ink/80 leading-relaxed font-spectral">
                      ...
                      narrate the probable stories of your family&apos;s migration patterns through
                      an emotionally resonant voice narrative.
                    </p>
                  </div>
                </motion.div>
